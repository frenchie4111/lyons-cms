...
?>
	...
	<script src="http://hodenfield.mikelyons.org/admin/stylesheets/edit.js"></script>
<?php 
$back = "index.php";
...
<?php
	if( isset( $_POST["id"] ) && isset( $_POST["title"] ) && isset( $_POST["content"] ) ) {
		if( $_POST["title"] != "" && $_POST["content"] != "" ) {
			...
			$query = "UPDATE stylesheets SET title='".$title."', content='".$content."' WHERE id=" . $_POST["id"];
			mysqli_query( $con, $query );
			log_action( $con, "Stylesheet Edited", "Stylesheet " . $_POST["id"] . " edited with title: " . $title . " and with content: " . $content );
